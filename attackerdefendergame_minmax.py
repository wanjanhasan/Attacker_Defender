...
print(type(initialHP), initialHP, type(depth), depth, type(noOfBranches), noOfBranches, type(noOfBaseChoices), noOfBaseChoices, type(arsenal), arsenal, type(theChoice), theChoice)
